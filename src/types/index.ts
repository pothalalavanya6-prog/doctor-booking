...
export interface Doctor { id: string; name: string; specialty: string; hospital: string; location: string; rating: number; experience: number; fee: number; phone: string; initials: string; avatar?: string; issueIds: string[]; slots: Record<string, TimeSlot[]>; }

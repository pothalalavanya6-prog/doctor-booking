...
export interface Doctor { id: string; name: string; specialty: string; rating: number; experience: number; fee: number; phone: string; initials: string; issueIds: string[]; slots: Record<string, TimeSlot[]>; }
export interface PatientDetails { fullName: string; age: string; gender: Gender; phone: string; address: string; landmark: string; problem: string; }
